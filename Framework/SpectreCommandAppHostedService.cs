...
using SecretServerCLI.Commands;

namespace SecretServerCLI.Framework
{
    /// <summary>
    ...
    public class SpectreCommandAppHostedService : IHostedService
    {
        ...
        public async Task DoWork(CancellationToken cancellationToken)
        {
            ...
            app.Configure(configurator =>
            {
                ...
                configurator.AddCommand<LoginCommand>("login");
                configurator.AddCommand<GetSecretCommand>("get-secret");
                configurator.AddCommand<GetSecretsCommand>("get-secrets");
                configurator.AddCommand<GetFoldersCommand>("get-folders");
                configurator.AddCommand<GetVersionCommand>("get-version");
